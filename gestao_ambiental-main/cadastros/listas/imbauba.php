...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($carregarDados == 'nao') {
        ...
        if (!empty($id)) {
            ...
            $sql = "UPDATE lista_imbauba SET item='$item', desc_item='$desc_item', descricao='$descricao' WHERE id = '$id'";
            $resultado = mysqli_query($con, $sql);
            ...
            $sql = "INSERT INTO lista_imbauba (item, desc_item, descricao) VALUES ('$item', '$desc_item', '$descricao')";
            $resultado = mysqli_query($con, $sql);
    ...
    if ($carregarDados == 'linha') {
        ...
        $sql = "SELECT * FROM lista_imbauba WHERE id = '$id' ";
        $resultado = mysqli_query($con, $sql);
    ...
    if ($carregarDados == 'delete') {
        ...
        $sql = "DELETE FROM lista_imbauba WHERE id = '$id' ";
        $resultado = mysqli_query($con, $sql);
