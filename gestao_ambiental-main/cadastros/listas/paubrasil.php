...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($carregarDados == 'sim') {
        ...
        $sql = "SELECT * FROM lista_pau_brasil";
    ...
    if ($carregarDados == 'nao') {
        ...
        if (!empty($id)) {
            ...
            $sql = "UPDATE lista_pau_brasil SET item='$item', desc_item='$desc_item', descricao='$descricao' WHERE id = '$id'";
            $resultado = mysqli_query($con, $sql);
            ...
            $sql = "INSERT INTO lista_pau_brasil (item, desc_item, descricao) VALUES ('$item', '$desc_item', '$descricao')";
            $resultado = mysqli_query($con, $sql);
    ...
    if ($carregarDados == 'linha') {
        ...
        $sql = "SELECT * FROM lista_pau_brasil WHERE id = '$id' ";
        $resultado = mysqli_query($con, $sql);
    ...
    if ($carregarDados == 'delete') {
        ...
        $sql = "DELETE FROM lista_pau_brasil WHERE id = '$id' ";
        $resultado = mysqli_query($con, $sql);
